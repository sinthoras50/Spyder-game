...
public class SpiderController : MonoBehaviour {
    ...
    private void Awake()
    {
        initialUp = spider.transform.up;
        initialRight = spider.transform.right;
    }
    ...
    void FixedUpdate() {
        ...
        {
            spider.transform.up = initialUp;
            spider.transform.right = initialRight;
        }
        ...
        Debug.Log("camera position = " + tempCamTargetPosition.x + " " + tempCamTargetPosition.y + " " + tempCamTargetPosition.y);
        Debug.Log("camera rotation = " + tempCamTargetRotation);
        spider.turn(input);
